// Package cal
// A lot of the CPP conventions were snaffooed from multiple places.
// CPP - https://programming.guide/go/format-parse-string-time-date-example.html
// CPP - https://en.cppreference.com/w/c/chrono/strftime
// CPP - https://cplusplus.com/reference/ctime/strftime/
// C - https://www.man7.org/linux/man-pages/man3/strftime.3.html
// C - https://www.man7.org/linux/man-pages/man3/strptime.3.html
// Python - https://strftime.org/
...
// RBase - https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/strptime
// "%e"|"%F"|"%g"|"%G"|"%h"|"%H"|"%I"|"%j"|"%m"|"%M"|"%n"|"%p"|"%r"|"%R"|"%S"|"%t"|"%T"|"%u"|"%U"|"%V"|"%w"|"%W"|"%x"|"%X"|"%y"|"%Y"|"%z"|"%Z"|"%%"
...
const DefaultConvertConfig = `[
  ...
  { "go": "", "java": "", "c": "%C", "notes": "Year divided by 100 and truncated to integer (00-99)" },
